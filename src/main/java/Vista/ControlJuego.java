...
public class ControlJuego {
    ...
    private void cargarPreguntas() {
        ...
        for (ColorPelo color : ColorPelo.values()) {
            preguntasDisponibles.add(new Pregunta(Filtro.COLOR_PELO, color));
        }
        for (Edad edad : Edad.values()) {
            preguntasDisponibles.add(new Pregunta(Filtro.EDAD, edad));
        }
        for (Grupo grupo : Grupo.values()) {
            preguntasDisponibles.add(new Pregunta(Filtro.GRUPO, grupo));
        }
