...
public abstract class MaquinaJugadora {
    ...
    protected List<Pregunta> preguntasDisponibles() {
        ...
        agregarSiAportaInfo(todas, Filtro.COLOR_PELO, List.of(ColorPelo.values()));
        agregarSiAportaInfo(todas, Filtro.EDAD, List.of(Edad.values()));
        agregarSiAportaInfo(todas, Filtro.GRUPO, List.of(Grupo.values()));
        return todas;
    }
